...
const Contact = () => {
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <div name="contact" className="w-full h-100vh bg-gray-800 flex justify-center items-center p-4">
        <form
          method="POST"
          name="myemailform"
        ...
        >
          <div className="pt-10 pb-8">
            <p className="text-4xl font-bold inline border-b-4 border-cyan-500 text-gray-200">Contact</p>
